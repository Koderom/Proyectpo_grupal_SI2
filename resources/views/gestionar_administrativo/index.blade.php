                        ...
                        <tbody>
                            ...
                            @foreach ($administrativos as $administrativo)
                                <tr>
                                    ...
                                    <th>{{ $administrativo->persona->user->name }}</th><td>
                                        <form action="{{ route('administrativo.destroy', $administrativo->persona_id) }}"
                                            method="post">
                                            @csrf
                                            @method('delete')
                                            <a href="{{ route('administrativo.show', $administrativo->persona_id) }}"
