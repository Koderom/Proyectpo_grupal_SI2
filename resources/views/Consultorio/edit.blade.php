                ...
                <div class="col-lg-7">
                    <div class="p-5">
                        <div class="text-center">
                            <h1 class="h4 text-gray-900 mb-4">Editas sala de consultorio</h1>
                        </div>
                        {{ csrf_field() }}
                        @if ($errors->any())
                        ...
                        @endif
                        <form class="user" action="{{route('consultorio.update',['sala'=>$sala])}}"  method="POST" enctype="multipart/form-data">
                            @method('put')
                          @csrf
                          <div class="form-group row">
                              <div class="col-sm-6 mb-3 mb-sm-0">
                                <label for="numero_de_sala">Numero de sala:</label>
                                <input type="text" class="form-control form-control-user" id="numero_de_sala" name="numero_de_sala" placeholder="Numero de sala" value="{{ old('numero_de_sala', $sala->nro_sala) }}">
                              </div>
                              <div class="col-sm-6 mb-3 mb-sm-0">
                                <label for="capacidad">Capacidad maxima de personas en la sala:</label>
                                <input type="text" class="form-control form-control-user" id="capacidad" name="capacidad" placeholder="capacidad" value="{{ old('capacidad', $sala->capacidad) }}">
                              </div>
