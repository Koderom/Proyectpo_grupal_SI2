                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route('doctores.destroy', [$doctor->id]) }}" method="post">
                                            @csrf
                                            @method('delete')
                                            <a href="{{ route('doctores.show', $doctor->id) }}" class="btn btn-info btn-sm fas fa-eye cursor-pointer"></a>
                                            <a href="{{ route('doctores.edit', $doctor->id) }}" class="btn btn-primary btn-sm fas fa-edit  cursor-pointer"></a>
